...
CREATE TABLE `tb_blog_info`  (
  `blog_id` bigint(20) NOT NULL COMMENT '博客表主键id',
...
CREATE TABLE `tb_blog_link`  (
  ...
  `link_type` tinyint(4) NOT NULL DEFAULT 0 COMMENT '友链类别 0-友链 1-推荐 2-个人网站 3-诗词',
...
INSERT INTO `tb_blog_link` VALUES (5, 3, '我爱纳兰词', 'https://mp.weixin.qq.com/s/CmimtBjYakCfO7zEacd-hQ', '纳兰词', 0, 0, '2026-05-31 00:00:00');
